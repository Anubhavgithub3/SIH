...
| **Pipeline Studio** | ⚡ | **Normalization Playground**: Single event, batch multi-line, **📁 Direct File Upload & Auto-Enrich**, execution telemetry, and **Live Network Flow Diagram** with animated pulse. |
